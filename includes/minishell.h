...
/*   Updated: 2023/04/25 18:23:26 by asadanow         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			fill_redirec(t_list *lst1, t_cmd_lst **cmd_lst, int files_count,
				int idx);
int			fill_cmd_lst(t_list *lst1, t_cmd_lst **cmd_lst, int idx);
int			malloc_cmd_lst(t_cmd_lst **cmd_lst, t_cmd_lst **head, int len1,
				int len2);
...
void		free_cmd_lst_solo(t_cmd_lst **cmd_lst, int cmds_count,
				int files_count);
